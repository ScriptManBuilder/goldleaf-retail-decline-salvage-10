...
const FAQSection: React.FC = () => {
  ...
  const faqs = [
    ...
    {
      question: 'Retail Businesses',
      answer: 'Merchants acquiring customers through retail channels, brick-and-mortar stores, and point-of-sale systems. We specialize in recovering failed payments from in-store transactions and retail acquisition flows.'
    },
    {
