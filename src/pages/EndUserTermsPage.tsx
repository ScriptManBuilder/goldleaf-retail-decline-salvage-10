      ...
      <LegalPageContainer>
        ...
        <LegalContent>
          ...
          <LegalSection>
            ...
            <LegalList>
              <LegalListItem>
                <strong>Payment Processing:</strong> Secure processing of payments for products ordered through retail
              </LegalListItem>
              <LegalListItem>
              ...
              <LegalListItem>
                <strong>Customer Service:</strong> Support for questions about your retail order
              </LegalListItem>
              <LegalListItem>
            ...
            <LegalParagraph style={{ marginTop: '1rem' }}>
              We process payments for products you ordered via retail. The products and services are provided 
